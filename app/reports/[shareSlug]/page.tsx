          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            ...
            <div className="border border-border bg-surface p-4 text-sm text-foreground md:min-w-64">
              ...
              {report.branded && (
                <Link
                  href="/"
                  className="mt-4 inline-flex items-center justify-center border border-accent/20 bg-accent/10 px-3 py-2 text-xs font-semibold text-accent transition hover:border-accent/40"
                >
                  Powered by PitzChat
                </Link>
              )}
      ...
      <section className="mx-auto w-full max-w-6xl px-5 py-10 sm:px-6 lg:px-8">
            ...
            <div>
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {report.campaign.keywords.map((keyword) => (
                  <span
                    key={keyword}
                    className="border border-border bg-zinc-950 px-2 py-1 text-xs font-semibold text-foreground"
                  >
                    {keyword}
                  </span>
                ))}
        ...
        {report.branded && (
          <footer className="mt-8 border-t border-border pt-6 text-center text-xs text-muted">
            Built with PitzChat, the Instagram comment-to-DM campaign OS.
          </footer>
        )}
      </section>
    </main>
