...
export const metadata: Metadata = {
  title: "Data Deletion - PitzChat",
  description:
    "How PitzChat customers can disconnect Instagram and request account or campaign data deletion.",
};
...
export default function DataDeletionPage() {
  return (
    <LegalShell
      title="Data Deletion"
      description="Use this page for Meta App Review and customer requests about removing PitzChat account, workspace, Instagram, and campaign data."
