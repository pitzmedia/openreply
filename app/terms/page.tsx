...
export const metadata: Metadata = {
  title: "Terms of Service - PitzChat",
  description:
    "Terms for using PitzChat's Instagram comment-to-DM campaign software.",
};
...
export default function TermsPage() {
  return (
    <LegalShell
      ...
      description="These terms define acceptable use for PitzChat's hosted Instagram comment-to-DM campaign service."
      updatedAt="May 24, 2026"
    >
      <section>
        <h2 className="text-xl font-bold text-white">Authorized Use</h2>
        <p className="mt-3">
          You may use PitzChat only with Instagram professional accounts you
      ...
      <section>
        ...
        <p className="mt-3">
          ...
          PitzChat may rate-limit, pause, or disable campaigns that create
      ...
      <section>
        ...
        <p className="mt-3">
          PitzChat depends on third-party platforms including Meta, email,
